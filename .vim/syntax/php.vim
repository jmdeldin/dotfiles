...
" set up variables based on global or buffer variables {{{1
  ...
  let s:show_sql = s:ChooseValue('php_sql_query', 1)

  " HTML in strings (s:show_html_in_strings) {{{2
  let s:show_html_in_strings = s:ChooseValue('php_htmlInStrings', 1)

  " Highlight the PHP baselib (s:show_baselib) {{{2
  let s:show_baselib = s:ChooseValue('php_baselib', 1)
  ...
  let s:show_quotes = s:ChooseValue('php_highlight_q1otes', 1)
